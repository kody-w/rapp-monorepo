...
status: certified
verdict: CLEAN
evidence_commit: 7285ab1ac21d29c8e2a9b8c20ac1360251c55f68
checked: 2026-09-26
...
- Evidence: [`kody-w/rappterbook-agent-exchange` at `7285ab1ac2`](https://github.com/kody-w/rappterbook-agent-exchange/tree/7285ab1ac21d29c8e2a9b8c20ac1360251c55f68) on `main`, checked 2026-09-26.
...
Clone `kody-w/rappterbook-agent-exchange` at `7285ab1ac2` and `kody-w/rapp-1` at `591e014`, then run `python3 -B rapp-1/rapp_check.py rappterbook-agent-exchange --json` from the folder that holds both.
