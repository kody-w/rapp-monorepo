"""
bookfactory_agent.py — the deployable BookFactory singleton.
...
__manifest__ = {
    ...
    "name": "@rapp/bookfactory_agent",
    "version": "0.3.0",
    "display_name": "BookFactory",
    "description": "Five-persona content pipeline (Writer, Editor, CEO, Publisher, Reviewer). Source material in, publishable chapter out — 8 LLM calls under one POST.",
    "author": "RAPP",
    "tags": ["composite", "creative-pipeline", "twin-stack", "singleton", "swarm"],
    "category": "pipeline",
...
__swarm__ = {
    ...
    "id": "bookfactoryagent",
    "display_name": "BookFactory",
    "summary": "Five-persona content pipeline (Writer -> Editor [5 specialists] -> CEO [2 specialists] -> Publisher -> Reviewer). One call, one chapter back. Best for: engineering writeups, blog posts, briefing docs, narrative content under 1500 words.",
    ...
    "metrics": {
        ...
        "wall_time_sec_per_call_p50": 75,
        "wall_time_sec_per_call_p90": 110,
        "cycle_3_corpus_win_rate": 0.625,
    },
    "example_call": {
        ...
        "body": {
            "name": "BookFactory",
            "args": {
                "source": "<your raw source material>",
                "chapter_title": "Whatever You Want",
                "author": "@you",
            },
        },
    },
    "egg_url": None,
    "spec_post": "blog/89-double-jump-loop.md",
    "license": "BSD-style",
}
...
class _InternalEditorRestructure(BasicAgent):
    def __init__(self):
        ...
        self.metadata = {
            "name": self.name,
            "description": "Consolidates repetitive middle sections.",
            "parameters": {"type": "object",
                "properties": {"input": {"type": "string", "description": "Draft prose"}},
                "required": ["input"]},
        }
...
class _InternalPersonaEditor(BasicAgent):
    def __init__(self):
        ...
        self.metadata = {
            "name": self.name,
            "description": "The Editor persona. Strips scaffolding, cuts weak prose, restructures.",
            "parameters": {
                "type": "object",
...
class _InternalPersonaCEO(BasicAgent):
    def __init__(self):
        ...
        self.metadata = {
            "name": self.name,
            "description": "The CEO persona. Risk + decision specialists.",
            "parameters": {
                "type": "object",
                "properties": {"input": {"type": "string", "description": "Content under review"}},
                "required": ["input"],
...
def _llm_call(soul: str, user_prompt: str) -> str:
    ...
    if endpoint and api_key:
        ...
        elif "/openai/v1/" not in url and "?" not in url:
