...
RAR (the registry, `@rapp/twin_agent.py`, and CONSTITUTION Article XXI) **references** this spec —
it is not copied here. The reference implementation is the [vBrainstem](https://github.com/kody-w/vbrainstem).
