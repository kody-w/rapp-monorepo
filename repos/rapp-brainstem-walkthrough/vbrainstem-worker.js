...
// Walkthrough delta vs vbrainstem: hacker_news_agent.py is seeded too, so the
// guided tour's agent-surgery arc (steps 7-11) has its subject in live mode.
const SEED_FILES = ['soul.md', 'agents/context_memory_agent.py', 'agents/manage_memory_agent.py', 'agents/hacker_news_agent.py'];
