...
TWIN = "tumbler"
CHANNEL_ID = "tumbler"
CHANNEL_PATH = os.path.join(REPO, "tumbler", "channel.json")
MARKER_PATH = os.path.join(REPO, "state", "tumbler-last-run.json")
CHANNEL_URL = "https://kody-w.github.io/rapp-vision-neighborhood/tumbler/channel.json"
NETWORK_URL = "https://kody-w.github.io/rapp-vision/channels.json"
PEER_SLUG = "fieldguide"
