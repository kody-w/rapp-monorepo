...
TWIN = "fieldguide"
CHANNEL_ID = "fieldguide"
CHANNEL_PATH = os.path.join(REPO, "fieldguide", "channel.json")
MARKER_PATH = os.path.join(REPO, "state", "fieldguide-last-run.json")
CHANNEL_URL = "https://kody-w.github.io/rapp-vision-neighborhood/fieldguide/channel.json"
