...
NEIGHBORHOOD = {
    ...
    "name": "RAPP Vision Sentinel Neighborhood (vision-court)",
    "slug": "vision-court",
    "purpose": "Watch the one failure an autonomous channel actually has: it "
               "is up, it serves 200, and it quietly stopped posting. "
               "Freshness is the invariant; HTTP status is not.",
    "watching": ["kody-w/rapp-vision-neighborhood"],
}
...
NEIGHBORS = {
    "fieldguide": "the Field Guide twin that posts the newcomer walkthrough",
}
