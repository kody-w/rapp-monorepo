...
It also presents `rapp-frame/2.0`, `brainstem-egg/2.3`, a six-field `/chat`
response, and GitHub collaborator authorization as current foundations. Those
are historical runtime/application profiles under RAPP/1, not current
protocol, egg, wire, or artifact-authentication rules.
